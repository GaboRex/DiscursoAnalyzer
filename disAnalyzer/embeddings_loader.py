...
def load_embeddings():
    ...
    with open("disAnalyzer/dataset/canciones.txt", encoding="utf-8") as f:
        text = f.read()
        canciones = text.split("===")

    with open("disAnalyzer/dataset/discursos.txt", encoding="utf-8") as f:
        text = f.read()
        discursos = text.split("===")

    with open("disAnalyzer/dataset/noticias.txt", encoding="utf-8") as f:
        text = f.read()
        noticias = text.split("===")
